  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarDark">
      <ul class="navbar-nav ms-auto mb-2 mb-xl-0 fs-5 text-center">
        ...
        <?php 
        # فقط کاربر با نام 'javad' لینک‌های مدیریت رو ببینه
        if (isset($_SESSION["state_login"]) && $_SESSION["state_login"] === true && isset($_SESSION["UserName"]) && $_SESSION["UserName"] === "javad") {
        ?>
          <li class="nav-item me-3">
